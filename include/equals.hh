 ...
 */
template <typename T>
bool ArrayBitEquals(T * arr1, T * arr2, size_t count);

extern template bool
ArrayBitEquals(real8 * arr1, real8 * arr2, size_t count);
 ...
 */
template<typename T>
bool ArrayFuzzyEquals(T * arr1, T * arr2, size_t count, real8 maxabserror = FuzzyEquals_default_maxabserror, real8 maxrelerror = FuzzyEquals_default_maxrelerror);

extern template bool
ArrayFuzzyEquals(real8 * arr1, real8 * arr2, size_t count, real8 maxabserror, real8 maxrelerror);
extern template bool
ArrayFuzzyEquals(complex16 * arr1, complex16 * arr2, size_t count, real8 maxabserror, real8 maxrelerror);
