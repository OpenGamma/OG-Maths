...
INSTANTIATE_NODE_TEST_CASE_P(NORM2Tests,NORM2,
  ...
  new CheckUnary<NORM2>( OGRealMatrix::create(new real8[1]{-1},1,1, OWNER), OGRealScalar::create(1.0), MATHSEQUAL),
  new CheckUnary<NORM2>( OGRealMatrix::create(new real8[3]{1,2,3},1,3, OWNER), OGRealScalar::create(3.74165738677394), MATHSEQUAL),
  new CheckUnary<NORM2>( OGRealMatrix::create(new real8[12]{1,4,7,10,2,5,8,11,3,6,9,12},4,3, OWNER), OGRealScalar::create(25.4624074360364), MATHSEQUAL),
  // test complex
