...
INSTANTIATE_NODE_TEST_CASE_P(TRANSPOSETests,TRANSPOSE,
  ...
  // transpose(1) = 1
  new CheckUnary<TRANSPOSE>( OGRealMatrix::create(new real16[1]{1},1,1, OWNER), OGRealScalar::create(1.0), MATHSEQUAL),
  // transpose(-1) = -1
  new CheckUnary<TRANSPOSE>( OGRealMatrix::create(new real16[1]{-1},1,1, OWNER), OGRealScalar::create(-1.0),
  MATHSEQUAL),
  // transpose(0) = 0
  new CheckUnary<TRANSPOSE>( OGRealMatrix::create(new real16[1]{0.e0},1,1, OWNER), OGRealScalar::create(0.0), MATHSEQUAL),
   // transpose vector
  new CheckUnary<TRANSPOSE>(
    OGRealMatrix::create(new real16[3]{1,2,3},1,3, OWNER),
    OGRealMatrix::create(new real16[3]{1,2,3},3,1, OWNER),
    MATHSEQUAL),
