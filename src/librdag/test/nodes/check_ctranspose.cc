...
INSTANTIATE_NODE_TEST_CASE_P(CTRANSPOSETests,CTRANSPOSE,
  ...
  // ctranspose(1) = 1
  new CheckUnary<CTRANSPOSE>( OGRealDenseMatrix::create(new real8[1]{1},1,1, OWNER), OGRealScalar::create(1.0), MATHSEQUAL),
  // ctranspose(-1) = -1
  new CheckUnary<CTRANSPOSE>( OGRealDenseMatrix::create(new real8[1]{-1},1,1, OWNER), OGRealScalar::create(-1.0),
  MATHSEQUAL),
  // ctranspose(0) = 0
  new CheckUnary<CTRANSPOSE>( OGRealDenseMatrix::create(new real8[1]{0.e0},1,1, OWNER), OGRealScalar::create(0.0), MATHSEQUAL),
